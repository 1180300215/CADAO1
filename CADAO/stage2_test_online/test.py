...
from stage2_test_online.utils.diffusion_utils import test_episodes
...
def main(args):
    ...
    encoder_state_dict = torch.load(args.encoder_param_path,map_location=device)
    ...
    decoder_state_dict = torch.load(args.decoder_param_path,map_location=device)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--switch_interval", type=int, default=30)
    parser.add_argument("--test_mode", type=str, default="seen", choices=["seen", "unseen", "mix"])
    args = parser.parse_args()
    
    if "MS" in args.project_name:  # * MS
        args.encoder_param_path = '../stage2_test_online/model/MS-pretrained_models/encoder30000'
        args.decoder_param_path = '../stage2_test_online/model/MS-pretrained_models/decoder30000.pt'
    elif "PA" in args.project_name:  # * PA
        args.encoder_param_path = '../stage2_test_online/model/PA-pretrained_models/encoder30000'   
        args.decoder_param_path = '../stage2_test_online/model/PA-pretrained_models/decoder30000.pt'
